...
router.post('/registernewroms', authMiddleware,async(req,res) =>{
    ...
    const queryInsertRomValue = [inputdata.title,inputdata.romPath.split('/')[5],inputdata.deviceid,inputdata.boxArtPath,inputdata.year,inputdata.developer,inputdata.romPath,inputdata.categories];
