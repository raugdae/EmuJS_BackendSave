...
router.post('/registernewroms', authMiddleware,async(req,res) =>{
    ...
    const queryInsertRomValue = [inputdata.title,inputdata.romPath.split('/')[3],inputdata.consoleid,inputdata.boxArtPath,inputdata.year,inputdata.developer,inputdata.romPath,inputdata.categories];
